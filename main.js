import RFMind from './src/RFMind';
import JSONFormatter from 'json-formatter-js'
function log(el, binding) {
    let renderer = new JSONFormatter(binding, 4, {
    ...
    // let renderer = new JsonFormatter.default(binding);
    el.innerHTML = '';
    ...
    if (!document.getElementById("json-formatter-style")) {
        ...
        //TODO 想办法写到另外的文件中，然后就是处理优化数据变动的时候从新append 的情况
...
document.getElementById('button').addEventListener('click', function () {
    log(document.getElementById('json-content'), mind.tree);
});
setTimeout(function () {
    log(document.getElementById('json-content'), mind.tree);
},2000);
...
mind.setText('circle');
log(document.getElementById('json-content'), mind.tree);
let node = mind.addNode({'text': '中心节点'});
console.log(node);
